	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			Public Function AddProductsRow(ByVal ProductName As String, ByVal QuantityPerUnit As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal UnitsOnOrder As Short) As ProductsRow
				...
				Dim columnValuesArray() As Object = { ProductName, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder}
...
Namespace DXSample.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ProductName, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder FROM P" & "roducts"
