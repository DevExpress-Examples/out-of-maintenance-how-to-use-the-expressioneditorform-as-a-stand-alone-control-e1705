...
Namespace DXSample
    Public Class UnboundExpressionPanel
        ...
        Protected Sub ApplyExpression(ByVal expression As String)
            If Arguments Is Nothing Then
                Return
            End If
            DirectCast(Arguments(0), GridColumn).UnboundExpression = expression
        End Sub
        ...
        Public Sub StartEdit(ParamArray ByVal arguments() As Object)
            ...
            Dim unboundColumn_Renamed As GridColumn = TryCast(arguments(0), GridColumn)
            If unboundColumn_Renamed Is Nothing Then
                Return
            End If
            fUnboundColumn = unboundColumn_Renamed
            DestroyForm()
    ...
    Public Class MyUnboundColumnExpressionEditorForm
        ...
        Private Function GetExpressionMemoEditText() As String
            ...
            Return If(Nothing Is column, String.Empty, column.UnboundExpression)
        End Function
